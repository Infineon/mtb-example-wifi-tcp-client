...
/*
#define NX_TCP_KEEPALIVE_INITIAL    1000
*/
...
/* This define specifies how many seconds between retries of the keepalive timer assuming the other side
   ...
   retries.  */
/*
#define NX_TCP_KEEPALIVE_RETRY      10
*/
...
/* Defines random number function, default is C library's rand() function.*/
UINT cy_rand( void );
#define NX_RAND                         cy_rand
#endif
